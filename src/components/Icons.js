...
export const TagIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const AxisIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    {/* X axis - horizontal */}
    <line x1="4" y1="16" x2="18" y2="16"></line>
    {/* Y axis - vertical */}
    <line x1="4" y1="16" x2="4" y2="4"></line>
    {/* Z axis - diagonal */}
    <line x1="4" y1="16" x2="10" y2="22"></line>
  </svg>
);
